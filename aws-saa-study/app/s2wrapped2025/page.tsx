  ...
  return (
    <html lang="en">
      <head>
        ...
        <title>Solutions Scheduler & Stats — 2025 Wrapped</title>
        <style>{`
:root {
  --bg:#0b1020; --panel:#121833; --panel2:#0f1530;
  --text:#e8ebff; --muted:#9aa3c7;
  --a:#6cf2c2; --b:#8aa2ff; --c:#ffb703; --d:#ff6b6b;
  --r:18px; --rs:12px; --shadow:0 20px 55px rgba(0,0,0,.38);
}
*{box-sizing:border-box}
html,body{margin:0;background:radial-gradient(1200px 650px at 20% -10%, #1b2350 0%, var(--bg) 60%);color:var(--text);font-family:Inter,ui-sans-serif,system-ui,-apple-system,Segoe UI,Roboto,Ubuntu,Cantarell,Noto Sans,Helvetica Neue,Arial}
a{color:var(--a);text-decoration:none}
a:hover{text-decoration:underline}
.container{max-width:1200px;margin:0 auto;padding:32px 20px 70px}
.hero{display:grid;grid-template-columns:1.25fr .75fr;gap:22px;align-items:center;background:linear-gradient(135deg,#182061,#0f1530);border-radius:var(--r);box-shadow:var(--shadow);padding:34px}
@media(max-width:900px){.hero{grid-template-columns:1fr}}
.badge{display:inline-flex;align-items:center;gap:8px;background:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.12);padding:8px 12px;border-radius:999px;color:var(--a);font-weight:700}
h1{font-size:clamp(36px,5vw,56px);margin:14px 0 10px;letter-spacing:-.02em}
h2{font-size:clamp(22px,3.2vw,34px);margin:0 0 12px;letter-spacing:-.02em}
h3{margin:0 0 10px}
.lead{font-size:18px;color:var(--muted);max-width:58ch;line-height:1.45}
.grid{display:grid;grid-template-columns:repeat(12,1fr);gap:20px;margin-top:22px}
.card{grid-column:span 4;background:linear-gradient(180deg,var(--panel),var(--panel2));border-radius:var(--r);padding:22px;box-shadow:var(--shadow)}
.card.wide{grid-column:span 8}
.card.full{grid-column:span 12}
@media(max-width:900px){.card,.card.wide{grid-column:span 12}}
.chips{display:flex;flex-wrap:wrap;gap:10px;margin-top:14px}
.chip{background:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.14);border-radius:999px;padding:8px 12px;font-weight:700;color:var(--text)}
.hero-metrics{display:grid;grid-template-columns:repeat(2,1fr);gap:14px}
.metric{background:rgba(0,0,0,.25);border:1px solid rgba(255,255,255,.12);border-radius:var(--rs);padding:16px}
.metric .n{font-size:32px;font-weight:900;color:var(--a)}
.metric .l{color:var(--muted);font-weight:700}
.small{font-size:13px;color:var(--muted);line-height:1.45}
.person{display:grid;grid-template-columns:auto 1fr;gap:14px;align-items:center;margin-top:10px}
.avatar{width:54px;height:54px;border-radius:14px;background:linear-gradient(135deg,var(--a),var(--b));display:grid;place-items:center;color:#0b1020;font-weight:900}
.person p{margin:6px 0 0;color:var(--muted)}
.split{display:grid;grid-template-columns:1fr 1fr;gap:18px}
@media(max-width:900px){.split{grid-template-columns:1fr}}
.linklist{margin:10px 0 0;padding-left:18px}
.linklist li{margin:10px 0}
.meta{display:block;color:var(--muted);font-size:12px;margin-top:3px}
.chartbox{background:rgba(0,0,0,.18);border:1px solid rgba(255,255,255,.12);border-radius:var(--rs);padding:14px;overflow:hidden}
.kpis{display:grid;grid-template-columns:repeat(3,1fr);gap:12px}
.kpi{background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.12);border-radius:14px;padding:14px;text-align:center}
.kpi .k{font-weight:900;color:var(--b);font-size:16px}
.kpi .v{font-weight:900;color:var(--text);font-size:28px;margin-top:6px}
.kpi .l{color:var(--muted);font-size:12px;margin-top:2px}
hr.sep{border:none;border-top:1px solid rgba(255,255,255,.12);margin:16px 0}
footer{margin-top:38px;text-align:center;color:var(--muted)}
        `}</style>
      </head>
      <body>
        <div className="container">
          ...
          <section className="grid">
            <div className="card wide">
              ...
              <div className="grid" style={{marginTop: '16px', gap: '14px'}}>
